...
% Plot: O(n) scaling
% Plot: Compare with serial-naive
% Plot: Hopper versus laptop
...
% Plot: Weak scaling(?) on Hopper: p = 1, 2, 4, 8, 16, 24; n = 1000, 4000, 16000, 64000 (* number of cores) [use more / less if possible on Hopper]
% Plot: Strong scaling(?) on Hopper: p = 1, 2, 4, 8, 16, 24; n = 1000, 4000, 16000, 64000
...
% Plot: O(n) scaling on Stampede: n = 1000, 4000, 16000, 64000, 256000, 1024000, 4096000
% Plot: Laptop versus Stampede: n = 1000, 4000, 16000, 64000, 256000, 1024000, 4096000 [last two on Stampede only due to memory constraints]
